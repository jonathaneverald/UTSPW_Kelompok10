...
?>
    ...
    <tr>
        ...
        <td>';
            if($data['stok'] == '0') {
                echo '<button type="button" class="btn btn-primary" disabled><a href="../process/beliProdukProcess.php?id='.$data['id'].'">BUY NOW</a></button>';
            } else {
                echo '<button type="button" class="btn btn-primary"><a href="../process/beliProdukProcess.php?id='.$data['id'].'">BUY NOW</a></button>';
            }
        echo '</td>
    </tr>';
 $no++;
